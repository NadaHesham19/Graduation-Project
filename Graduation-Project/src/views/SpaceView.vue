            ...
            <div class="row align-items-center justify-content-evenly">
                <div class="col-6">
                    ...
                    <ul class="list-unstyled lh-lg ms-5 mb-5">
                        ...
                        <li class="align-items-center m-3 fs-4 "><i class="fa-solid fa-bell me-3"></i>
                            Services is here
                        </li>
                    </ul>
                </div>
                <div class="col-6 mb-5">
                    <img class="img-fluid image mt-5 " :src="firstImgSrc" alt="" width="520">
                </div>
            </div>
...
export default {
    ...
    // },
    mounted() {
        this.latitude = 30.06436416981507;   //parseFloat(lat)
        this.longitude = 31.27810362252527;
        // 30.065914025055683, 31.282058295558517
    ...
    computed: {
        firstImgSrc() {
            return this.spaceDetails.images;
        },
        totalPages() {
